...
def main():
    translate_text('I am a seeker of knowledge learning to code in AWS','en','zh') # we provide the value for the arguments when we call the function in the correct positional order.
